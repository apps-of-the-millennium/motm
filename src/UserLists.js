        ...
        <div>
            <div style={{ marginBottom: '48px' }}>
                ...
                <div className="section-posts list">
                    ...
                    <button className="view-more-list" onClick={() => viewMore('favouriteList')}>View More<br/><FiArrowRightCircle className="view-more-list arrow-list" style={style} /></button>
                </div>
            </div>
            ...
            <div style={{ marginBottom: '48px' }}>
                ...
                <div className="section-posts list">
                    ...
                    <button className="view-more-list" onClick={() => viewMore('laterList')}>View More<br/><FiArrowRightCircle className="view-more-list arrow-list" style={style} /></button>
                </div>
            </div>
            ...
            <div style={{ marginBottom: '48px' }}>
                ...
                <div className="section-posts list">
                    ...
                    <button className="view-more-list" onClick={() => viewMore('completedList')}>View More<br/><FiArrowRightCircle className="view-more-list arrow-list" style={style} /></button>
                </div>
            </div>
